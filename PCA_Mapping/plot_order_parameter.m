...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Used to plot order parameters for better presentation.
% The index selection should be done MANUALLY.
%
% Editor: Hong-Rui
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	s_2 = plot(res_id_2,o_2,'gs-');
	hold on
	s_1 = plot(res_id_1,o_1,'b.-');
	hold on
	s_0 = plot(res_id_0,o_0,'rx-');
	hold on
	s_exp = plot(res_id_exp,o_exp,'ko');
