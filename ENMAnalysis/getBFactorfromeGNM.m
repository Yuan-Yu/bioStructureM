function [B_factor] = getBFactorfromeGNM(pdb,eigvalues,mode_selection)
%%%%%%%%%%%%%%%%%%%%need eGNM attributes in PDBStructure%%%%%%%%%%%%%%
% input:
%   pdb is the structure gotten from cafrompdb with eGNM attributes.
%	eigvalues is the eGNM eigenvalues.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	atom_num = length(pdb);
	SpringConst = getSpringConsteGNM(pdb,eigvalues);
	...
	eigvectors = geteGNM(pdb,mode_selection);
